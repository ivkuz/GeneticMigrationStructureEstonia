...
#############################################################################################
# Also makes plot with mean PRS in the groups of born in or migrated to the cities Figure 7 #
#############################################################################################
...
option_list = list(
  ...
  make_option(c("-o", "--out"), type="character", default="figures/", 
...
#####################################################################################################
# Make Figure 4 (two panels for the population level - cities and counties) #########################
# Third panel is the plot produced by figure4_sib_panel and is for county level within-sibling data #
#####################################################################################################

plot_list <- plotBars(ebb[Nat=="Eestlane",])
plot_list[[3]] <- readRDS(paste0(opt$out, "pl_sib_bars_counties.rds"))

pdf(paste0(opt$out, "Figure4.pdf"), width=7, height = 2.5)
...
grid.text("B", x = 0.280, y = 0.95, gp = gpar(fontsize=14, fontface = "bold"))
grid.text("C", x = 0.539, y = 0.95, gp = gpar(fontsize=14, fontface = "bold"))
...
pdf(paste0(opt$out, "MigrationBars_E_R.pdf"), width=7, height = 2.8)
...
pdf(paste0(opt$out, "MigrationBars_E_nonrel.pdf"), width=7, height = 2.8)
...
pdf(paste0(opt$out, "MigrationBars_E_sib.pdf"), width=7, height = 2.8)
...
pdf(paste0(opt$out, "MigrationBars_Sex_MF.pdf"), width=7, height = 5.6)
...
pdf(paste0(opt$out, "MigrationBars_Age_young-old.pdf"), width=7, height = 11)
...
pdf(paste0(opt$out, "MigrationBars_YoA.pdf"), width=7, height = 5.6)
...
pdf(paste0(opt$out, "MigrationBars_suppl_E_R.pdf"), width=7, height = 2.8)
...
pdf(paste0(opt$out, "MigrationBars_suppl_E_nonrel.pdf"), width=7, height = 2.8)
...
pdf(paste0(opt$out, "MigrationBars_suppl_Sex_MF.pdf"), width=7, height = 5.6)
...
pdf(paste0(opt$out, "MigrationBars_suppl_Age_young-old.pdf"), width=7, height = 11)
...
pdf(paste0(opt$out, "MigrationBars_suppl_YoA.pdf"), width=7, height = 5.6)
...
pdf(paste0(opt$out, "MigrationBars_suppl2_E_R.pdf"), width=7, height = 2.8)
...
pdf(paste0(opt$out, "MigrationBars_suppl2_E_nonrel.pdf"), width=7, height = 2.8)
...
pdf(paste0(opt$out, "MigrationBars_suppl2_E_sib.pdf"), width=7, height = 2.8)
...
pdf(paste0(opt$out, "MigrationBars_suppl2_Sex_MF.pdf"), width=7, height = 5.6)
...
pdf(paste0(opt$out, "MigrationBars_suppl2_Age_young-old.pdf"), width=7, height = 11)
...
pdf(paste0(opt$out, "MigrationBars_suppl2_YoA.pdf"), width=7, height = 5.6)
...
##################################################################################################
# Make PDF with plot with mean PRS in the groups of born in or migrated to the cities (Figure 7) #
##################################################################################################
...
# Make the final plot
pdf(paste0(opt$out, "MigrationBars_refEstonia_YoB.pdf"), width=7, height = 5.6)
print(
  grid.arrange(
    grobs = plots,
    widths = c(1, 0.065),
...
pdf(paste0(opt$out, "distribution_comp_QA.pdf"), width=7, height = 5.6)
